...
F 1 "10k" V 1525 1650 50  0000 C CNN
...
optical isolation\n
Text Notes 1175 2361 0    39   Italic 0
R1 limits input current (2.8mA at 28V)\nChip sees 3.3V regardless of input voltage.\n(excess current is shunted through zener)\nR2 limits chip current to 17mA (just in case)
NoConn ~ 3030 1850
$Comp
L VCC #PWR5
U 1 1 5798291D
